document.addEventListener('DOMContentLoaded', () => {
    ...
    if (orderId) {
        ...
        // If no order ID, show error and redirect
...
function displayOrderConfirmation(orderId) {
    ...
    // Calculate Estimated Delivery (e.g., 5 days from order date)
    ...
    // Calculate and update total items and grand total
    ...
    // Display order confirmation with summary and details
    document.getElementById('orderConfirmation').innerHTML = `
